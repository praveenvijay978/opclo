...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, i as utf8ToBytes, E as ExternalError, k as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, m as RequestStatusResponseStatus, U as UnknownError, n as RequestStatusDoneNoReplyErrorCode, o as RejectError, p as CertifiedRejectErrorCode, q as UNREACHABLE_ERROR, I as InputError, s as InvalidReadStateRequestErrorCode, t as ReadRequestType, v as Principal, w as IDL, x as MissingCanisterIdErrorCode, y as HttpAgent, z as encode, Q as QueryResponseStatus, A as UncertifiedRejectErrorCode, D as isV3ResponseBody, F as isV2ResponseBody, G as UncertifiedRejectUpdateErrorCode, J as UnexpectedErrorCode, K as decode, N as Subscribable, O as pendingThenable, V as resolveEnabled, W as shallowEqualObjects, X as resolveStaleTime, Y as noop$1, Z as environmentManager, _ as isValidTimeout, $ as timeUntilStale, a0 as timeoutManager, a1 as focusManager, a2 as fetchState, a3 as replaceData, a4 as notifyManager, a5 as hashKey, a6 as getDefaultState, r as reactExports, a7 as shouldThrowError, a8 as useQueryClient, a9 as useInternetIdentity, aa as createActorWithConfig, ab as Record, ac as Variant, ad as Opt, ae as Vec, af as Service, ag as Func, ah as Text, ai as Nat, aj as Null, ak as Int, al as Principal$1, am as Float64, an as Bool, j as jsxRuntimeExports } from "./index-DrGu1WxZ.js";
...
Service({
  ...
  "extendShopHours": Func([Text], [Bool], []),
  "getAllShops": Func([], [Vec(Shop)], ["query"]),
  "getFavorites": Func([], [Vec(Shop)], ["query"]),
  "getOwnerShop": Func([], [Opt(Shop)], ["query"]),
  "getReviews": Func([Nat], [Vec(Review)], ["query"]),
  "getShopById": Func([Nat], [Opt(Shop)], ["query"]),
  "getShopsByCategory": Func([ShopCategory], [Vec(Shop)], ["query"]),
  "initSeed": Func([], [], []),
  "registerShop": Func([ShopInput], [Shop], []),
  "searchShops": Func([Text], [Vec(Shop)], ["query"]),
  "toggleFavorite": Func([Nat], [Bool], []),
  "updateShopHours": Func([Text, Text], [Bool], []),
  "updateShopStatus": Func([Bool], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const ShopCategory2 = IDL2.Variant({
    "JuiceShop": IDL2.Null,
    "SnackShop": IDL2.Null,
    "StreetFood": IDL2.Null,
    "Cafe": IDL2.Null,
    "Bakery": IDL2.Null,
    "Other": IDL2.Text,
  ...
  const Shop2 = IDL2.Record({
    ...
    "photoKeys": IDL2.Vec(IDL2.Text),
    "ownerId": IDL2.Principal,
    "name": IDL2.Text,
    "createdAt": IDL2.Int,
    "openingTime": IDL2.Text,
    "offers": IDL2.Vec(IDL2.Text),
    "isOpen": IDL2.Bool,
    "longitude": IDL2.Float64,
    "address": IDL2.Text,
    "category": ShopCategory2,
    "closingTime": IDL2.Text,
    "rating": IDL2.Float64,
    "phone": IDL2.Text,
    "reviewCount": IDL2.Nat,
    "instagramId": IDL2.Opt(IDL2.Text)
  });
  ...
  return IDL2.Service({
    ...
    "extendShopHours": IDL2.Func([IDL2.Text], [IDL2.Bool], []),
    "getAllShops": IDL2.Func([], [IDL2.Vec(Shop2)], ["query"]),
    "getFavorites": IDL2.Func([], [IDL2.Vec(Shop2)], ["query"]),
    "getOwnerShop": IDL2.Func([], [IDL2.Opt(Shop2)], ["query"]),
    "getReviews": IDL2.Func([IDL2.Nat], [IDL2.Vec(Review2)], ["query"]),
    "getShopById": IDL2.Func([IDL2.Nat], [IDL2.Opt(Shop2)], ["query"]),
    "getShopsByCategory": IDL2.Func([ShopCategory2], [IDL2.Vec(Shop2)], ["query"]),
    "initSeed": IDL2.Func([], [], []),
    "registerShop": IDL2.Func([ShopInput2], [Shop2], []),
    "searchShops": IDL2.Func([IDL2.Text], [IDL2.Vec(Shop2)], ["query"]),
    "toggleFavorite": IDL2.Func([IDL2.Nat], [IDL2.Bool], []),
    "updateShopHours": IDL2.Func([IDL2.Text, IDL2.Text], [IDL2.Bool], []),
    "updateShopStatus": IDL2.Func([IDL2.Bool], [IDL2.Bool], [])
  });
};
...
class Backend {
  ...
  async updateShopHours(arg0, arg1) {
    if (this.processError) {
      try {
...
function from_candid_ShopCategory_n4(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n5(_uploadFile, _downloadFile, value);
}
function from_candid_Shop_n2(_uploadFile, _downloadFile, value) {
...
function to_candid_ShopCategory_n8(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n9(_uploadFile, _downloadFile, value);
}
function to_candid_ShopInput_n10(_uploadFile, _downloadFile, value) {
...
function useAllShops() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const result = await actor.getAllShops();
      return result;
    },
    enabled: !isFetching,
...
function useShopsByCategory(category) {
  const { actor, isFetching } = useShopActor();
  return useQuery({
    queryKey: ["shops", "category", category],
    queryFn: async () => {
      if (!actor) return sampleShops.filter((s) => s.category === category);
      const result = await actor.getShopsByCategory(category);
      return result;
    },
    enabled: !isFetching,
...
function useShopById(id2) {
  const { actor, isFetching } = useShopActor();
  return useQuery({
    queryKey: ["shops", "id", id2.toString()],
    queryFn: async () => {
      if (!actor) return sampleShops.find((s) => s.id === id2) ?? null;
      const result = await actor.getShopById(id2);
      if (result === null || result === void 0) return null;
      const r = result;
      if (Array.isArray(r) && r.length === 0) return null;
      if (Array.isArray(r) && r.length === 1) return r[0];
...
function useSearchShops(query) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return actor.searchShops(query);
    },
...
function useReviews(shopId) {
  const { actor, isFetching } = useShopActor();
  return useQuery({
    queryKey: ["reviews", shopId.toString()],
    queryFn: async () => {
      if (!actor) return [];
      return actor.getReviews(shopId);
    },
    enabled: !isFetching
  });
}
function useAddReview() {
  ...
  return useMutation({
    ...
    onSuccess: (_data, vars) => qc.invalidateQueries({ queryKey: ["reviews", vars.shopId.toString()] })
  });
}
function useOwnerShop() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      const result = await actor.getOwnerShop();
      if (result === null || result === void 0) return null;
      const r = result;
      if (Array.isArray(r) && r.length === 0) return null;
      if (Array.isArray(r) && r.length === 1) return r[0];
...
function useExtendShopHours() {
  const { actor } = useShopActor();
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (newClosingTime) => {
      if (!actor) throw new Error("Not connected");
      return actor.extendShopHours(
        newClosingTime
      );
    },
    onSuccess: () => qc.invalidateQueries({ queryKey: ["owner"] })
...
export {
  ...
  useShopsByCategory as f,
  useShopById as g,
  useReviews as h,
  isHTMLElement as i,
  useFavorites as j,
  useAddReview as k,
  useToggleFavorite as l,
  motion as m,
  useSearchShops as n,
  useOwnerShop as o,
  useUpdateShopStatus as p,
  useExtendShopHours as q,
  useUpdateShopHours as r,
  useRegisterShop as s,
  useAllShops as u
};
